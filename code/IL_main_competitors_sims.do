...
replace F_origsvdrtf = F_origsvdrtf + 3.6363636 if year == 2012 & orig == "IOWA"
replace F_origsvdrtf = F_origsvdrtf + 2.1212121 if year == 2012 & orig == "KANSAS"

replace F_destsvdrtf = F_destsvdrtf + 3.6363636 if year == 2012 & dest == "IOWA"
replace F_destsvdrtf = F_destsvdrtf + 2.1212121 if year == 2012 & dest == "KANSAS"
...
putexcel set "output/ag_profit_sims_IL.xlsx", modify sheet(competitors)
